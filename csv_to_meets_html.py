...
<div class="athlete">
    <figure>
        <a href="../images/profiles/{profile_pic}" data-lightbox="gallery" data-title="{name} - Time: {time}, Place: {place}, Grade: {grade}">
...
def select_random_photos(folder_path, num_photos=21):
...
def create_meet_image_gallery(url):
    ...
    folder_path = f'images/meet_pics/'
